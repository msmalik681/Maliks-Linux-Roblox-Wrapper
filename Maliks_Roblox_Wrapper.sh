...
echo -e "${Green}Setup complete. When you lauch a game from the website, You will then need to launch \"Run_RobloxGame_Malik.run\" from your desktop.${Reset}"
main_menu
